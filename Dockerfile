...
RUN apt-get update&&apt-get -y upgrade&&apt-get clean&&rm -rf /var/lib/apt/lists/*&&apt-get install cron -y&&service cron start&&pip install playwright&&playwright install
